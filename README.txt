CSC 242 Project1 Checkers
Spring 2020 
Prof George Ferguson
Contributors: Kashish Dewnani (kdewnani)
                         Shivali Singh (ssingh53)
Note: Kashish Dewnani received a deadline extension to 2/12 from Prof Ferguson.
...
For 8x8board: When move count exceeds 30 moves/ player.
